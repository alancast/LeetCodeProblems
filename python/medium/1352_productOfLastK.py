...
testCase.add(5)
testCase.add(4)
assert testCase.getProduct(2) == 20, f"Expected 20 but got {testCase.getProduct(2)}"  # noqa: PLR2004
assert testCase.getProduct(3) == 40, f"Expected 40 but got {testCase.getProduct(3)}"  # noqa: PLR2004
...
testCase.add(8)
assert testCase.getProduct(2) == 32, f"Expected 32 but got {testCase.getProduct(3)}"  # noqa: PLR2004
